...
public class LocalitySensitiveHashing {
    ...
    private static int numFunctionBundles = 50; // k
    private static double binLength = 3d;        // w

    private static double[][] hashA = null;     // a
    private static double[] hashB = null;       // b
    private static double dilation = 50d;       // defines how "stretched out" the hash values are.
