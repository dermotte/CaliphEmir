...
import at.lux.fotoretrieval.retrievalengines.FileSystemRetrieval;
 ...
 */
public class SimilarImageSearchThread extends Thread {
    Set <Element> visualDescriptor;
    String dir;
    boolean recursive;
    ...
    public SimilarImageSearchThread(Element visualDescriptor, String directory, boolean descend,
...
public SimilarImageSearchThread(Set<Element> visualDescriptor, String directory, boolean descend,
                                RetrievalFrame frame, JProgressBar progress) {
    ...
    public void run() {
        ...
        RetrievalEngine engine = RetrievalEngineFactory.getFileSystemRetrievalEngine();
        List<ResultListEntry> results = engine.getSimilarImages_fromSet(visualDescriptor, dir, recursive, progress);
