 ...
 */
public class SearchSemanticDescriptionThread extends Thread {
    String dir, xPath;
    boolean recursive;
    ...
    public SearchSemanticDescriptionThread(String xPath, Vector objects, String directory, boolean descend,
    ...
    public void run() {
        ...
        Vector results = new Vector(engine.getImagesBySemantics(xPath, objects, dir, recursive, progress));
