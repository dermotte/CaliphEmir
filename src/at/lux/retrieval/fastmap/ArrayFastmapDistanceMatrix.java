...
public class ArrayFastmapDistanceMatrix implements FastmapDistanceMatrix {
    ...
    public SimilarityMatrix getSimilarityMatrix() {
        ...
        ArrayList objects = new ArrayList(this.objects);
        ArraySimilarityMatrix matrix = new ArraySimilarityMatrix(similarity, objects);
        return matrix;  //To change body of implemented methods use File | Settings | File Templates.
    }
