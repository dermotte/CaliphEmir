 ...
 */
public class SearchSemanticInPathIndexThread extends Thread {
//    Element visualDescriptor;
    ...
    public SearchSemanticInPathIndexThread(String xPath, String directory, boolean descend,
    ...
    public void run() {
        ...
        engine = RetrievalEngineFactory.getPathIndexRetrievalEngine();
        stime = System.currentTimeMillis();
        java.util.List<ResultListEntry> results = engine.getImagesBySemantics(xPath, null, dir, recursive, progress);
        stime = System.currentTimeMillis() - stime;
//        System.out.println(stime);
//        System.out.println(results.size());
        ftime = System.currentTimeMillis();
        parent.setStatus("Formatting results ...");
        ResultsPanel rp = new ResultsPanel(new Vector(results), progress, parent.getQualityConstraints());
